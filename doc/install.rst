...
You can download the snapshot addon from `here <http://pmatic.larsmichelsen.com/pmatic-snapshot_ccu.tar.gz>`_.
...
`Download the file <http://pmatic.larsmichelsen.com/pmatic-snapshot_ccu.tar.gz>`_
