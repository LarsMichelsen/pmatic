...
class EventHandler(object):
    ...
    # String   interface_id,   String   address,   String value_key, ValueType value
    ...
    # Diese  Methode  gibt  alle  der  Logikschicht  bekannten 
    # Geräte  für  den  Schnittstellen-prozess mit der Id interface_id
    #  in Form von Gerätebeschreibungen zurück. Damit 
    # kann  der  Schnittstellenprozess  durch  Aufruf  von  new
    # Devices()  und  deleteDevices() einen Abgleich vornehmen. 
    # Damit  das  funktioniert,  muss  sich  die  Logikschicht 
    # diese  Informationen  zumindest teilweise merken. Es ist dabei ausreichend, wenn je
    # weils die Member ADDRESS und VERSION einer DeviceDescription gesetzt sind. 
    def listDevices(self, *args):
        print("LIST_DEVICES", *args)
        return []
    ...
    # mitgeteilt. 
    def updateDevices(self, *args):
        print("UPDATE_DEVICES", *args)
